...
internal cube_t
cube_init2(f32 *vertices, u32 vertices_count, char *texture_diffuse_filename, char *texture_specular_filename)
{
	cube_t Result = {};
...
int main(void)
{
	...
	model_process(&AppState, "models/backpack/backpack.obj", "shaders/backpack.vs", NULL, "shaders/backpack.fs");


	// NOTE(Justin): We are using this funciton to generate VBOs and VAOs of the
	// lamp that acts as the light source. We are not using the shaders or textures.
