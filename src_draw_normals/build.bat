...
set main_file=demo_draw_normals.cpp
...
cl ..\src_draw_normals\%main_file%  %common_compiler_flags% %include_directories%  /link /NODEFAULTLIB:"LIBCMT" %lib_directories% %common_linker_flags% 
popd
