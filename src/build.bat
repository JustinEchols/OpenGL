...
set common_compiler_flags=-nologo -W4 -Zi -wd4100 -wd4005 -wd4201 -wd4800 -wd4244 -DGLEW_STATIC=1 -D_CRT_SECURE_NO_WARNINGS=1
set common_linker_flags=gdi32.lib user32.lib shell32.lib msvcrt.lib opengl32.lib winmm.lib glew32s.lib glfw3.lib assimp-vc142-mtd.lib
...
cl ..\src\application.cpp %common_compiler_flags% %include_directories%  /link %lib_directories% %common_linker_flags% 
popd
